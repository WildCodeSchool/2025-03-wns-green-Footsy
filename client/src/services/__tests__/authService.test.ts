...
//       const mockResponse =
//         '{"id":1,"firstName":"John","lastName":"Doe","mail":"john@example.com"}; token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...';
...
//       expect(() => parseLoginResponse(invalidResponse)).toThrow(
...
//       expect(() => parseLoginResponse(malformedResponse)).toThrow(
//         "Failed to parse login response"
//       );
//     });
//   });
...
//       await expect(
//         login(mockApolloClient, "invalid@example.com", "wrongpassword")
...
//       await expect(
//         login(mockApolloClient, "john@example.com", "password123")
